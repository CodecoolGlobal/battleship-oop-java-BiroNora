...
public class Ship {
    ...
    public Ship(ShipType shiptype, int[] rowCol, Direction direction) {
        switch (shiptype) {
            case CARRIER, BATTLESHIP, CRUISER, DESTROYER, SUBMARINE -> placeLineShip(rowCol, shiptype.getNumberOfSquares(), direction);
            case CARRIER_L_SHAPE -> placeCarrierLShape(rowCol, direction);
            case CARRIER_T_SHAPE -> placeCarrierTShape(rowCol, direction);
            case BATTLESHIP_Z_SHAPE -> placeBattleshipZShape(rowCol, direction);
            case CRUISER_L_SHAPE -> placeCruiserLShape(rowCol, direction);
        }
    }
